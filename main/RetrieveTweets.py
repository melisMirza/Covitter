...
def getTweetDF(option,fromDate="",toDate="",searchwords=""):
    ...
    if option.lower() == "all":
        query = 'SELECT post_content,post_date,post_lemmatized,hashtags,sentiment_result,mentions_screen_name,favourite_count,retweet_count,entities FROM twitter ORDER BY id DESC LIMIT 100'
        ...
        query = 'SELECT post_content,post_date,post_lemmatized,hashtags,sentiment_result,mentions_screen_name,favourite_count,retweet_count,entities FROM twitter WHERE post_date >= \'%s\' AND post_date < \'%s\' ORDER BY id DESC LIMIT 1000' %(lastweek_date,today)
        cur.execute(query)  
        output = cur.fetchall()
        dbconn.commit() 
        cur.close()
        ...
        query = 'SELECT post_content,post_date,post_lemmatized,hashtags,sentiment_result,mentions_screen_name,favourite_count,retweet_count,entities FROM twitter WHERE post_date = \'%s\' ORDER BY id DESC LIMIT 1500' %(today)
        cur.execute(query)  
        output = cur.fetchall()
        dbconn.commit() 
        cur.close()
        ...
        if fromDate != "" and toDate != "":
            ...
            if searchwords == "":
                query = 'SELECT post_content,post_date,post_lemmatized,hashtags,sentiment_result,mentions_screen_name,favourite_count,retweet_count,entities FROM twitter WHERE post_date <= \'%s\' ORDER BY post_id DESC LIMIT 1500' %(toDate)
            else:
                query = 'SELECT post_content,post_date,post_lemmatized,hashtags,sentiment_result,mentions_screen_name,favourite_count,retweet_count,entities FROM twitter WHERE post_date <= \'%s\' AND LOWER(post_content) LIKE '%(toDate) +'\'%' + searchwords + '%\'' + ' ORDER BY post_id DESC LIMIT 1500'
            print(query)
            cur.execute(query)  
            output = cur.fetchall()
            dbconn.commit()
            ...
            if searchwords == "":
                query = 'SELECT post_content,post_date,post_lemmatized,hashtags,sentiment_result,mentions_screen_name,favourite_count,retweet_count,entities FROM twitter WHERE post_date >= \'%s\' ORDER BY post_id ASC LIMIT 1500' %(fromDate)
            else:
                query = 'SELECT post_content,post_date,post_lemmatized,hashtags,sentiment_result,mentions_screen_name,favourite_count,retweet_count,entities FROM twitter WHERE post_date >= \'%s\' AND LOWER(post_content) LIKE '%(fromDate) +'\'%' + searchwords + '%\'' + ' ORDER BY post_id ASC LIMIT 1500'
            print(query)
            cur.execute(query)  
            output = cur.fetchall()
            dbconn.commit()
        ...
        query = 'SELECT post_content,post_date,post_lemmatized,hashtags,sentiment_result,mentions_screen_name,favourite_count,retweet_count,entities FROM twitter WHERE LOWER(post_content) LIKE ' +'\'%' + searchwords + '%\'' + ' ORDER BY post_id DESC LIMIT 1500'
        print(query)
        cur.execute(query)  
        output = cur.fetchall()
        dbconn.commit() 
    ...
    for tweet in output:
        #print(tweet)
        (orig_content,post_date,lemma,tags,sentiment,mentions,favourite_count,retweet_count,entities) = tweet
